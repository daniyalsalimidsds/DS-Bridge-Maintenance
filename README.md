...
برای دریافت کد همراه با مجوز متن‌باز، از شاخهٔ `main` همین مخزن استفاده کنید. فایل‌های انتشار تاریخی و هش‌های آن‌ها حفظ شده‌اند؛ فایل مجوز در بسته‌های قدیمی ممکن است موجود نباشد.
...
توسعه‌دهنده و دارندهٔ حق مؤلف کد پروژه: **دانیال سلیمی — Daniyal Salimi**.

کد و مستندات تألیفی پروژه تحت **[مجوز MIT](LICENSE)** منتشر می‌شوند. استفادهٔ شخصی و تجاری، تغییر و بازتوزیع با حفظ اعلان حق مؤلف و متن مجوز مجاز است. نرم‌افزار مطابق همین مجوز بدون ضمانت ارائه می‌شود؛ ارزیابی و تصمیم مهندسی همچنان به بررسی متخصص نیاز دارد.

مجوز MIT جایگزین مجوز فونت‌ها، AndroidX، ابزارهای همراه یا حقوق منابع مرجع ثالث نیست. جزئیات و موارد خارج از دامنهٔ MIT در [مجوز وابستگی‌ها](docs/DEPENDENCY_LICENSES.md) و [منشأ دارایی‌ها](docs/THIRD_PARTY_ASSETS.md) آمده است. متن MIT برای همراه‌شدن با ساخت‌های بعدی برنامه در `app/src/main/assets/licenses/MIT.txt` نیز قرار دارد.
